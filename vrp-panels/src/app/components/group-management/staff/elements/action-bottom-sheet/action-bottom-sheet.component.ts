...
import { EditMultipleWorkersComponent } from '../edition/edit-multiple-workers.component';
...
export class ActionBottomSheetComponent implements OnInit {
  ...
  edit() {
    const dialogRef = this._editWorkerDialog.open(EditMultipleWorkersComponent, {
      data: this.data,
      maxWidth: '60vh'
    });
