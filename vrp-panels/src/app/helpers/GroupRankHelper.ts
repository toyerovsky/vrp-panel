...
export default class GroupRightsHelper {
  ...
  private static getPanel(workerModel: WorkerModel): boolean {
    return (workerModel.rights & 32768) === 32768;
  }

  private static getPanelValue(right: WorkerRightsModel): number {
    return right.ninth ? 32768 : 0;
  }

  private static getPanelFromRank(rankModel: GroupRankModel): boolean {
    return (rankModel.rights & 32768) === 32768;
  }
  ...
  public static workerToRights(workerModel: WorkerModel): WorkerRightsModel {
    return {
      ...
      panel: this.getPanel(workerModel)
    };
  }
  ...
  public static workerToRightsIncludeRankRights(workerModel: WorkerModel): WorkerRightsModel {
    return {
      ...
      panel: this.getPanel(workerModel) || this.getPanelFromRank(workerModel.groupRank)
    };
  }
  ...
  public static rankToRights(rankModel: GroupRankModel): WorkerRightsModel {
    return {
      ...
      panel: this.getPanelFromRank(rankModel)
    };
  }
